...
var track = require('./../../../common/javascripts/constants/tracking');
...
class ChartWidget {
  ...
  onClick() {
    if (!this.props.trackedClickEngagement) {
      handleGaEvent(...track.ENGAGED_WITH_BELOW_THE_LINE_CHART, 'click');
    ...
    if (!self.props.hoverEngagementTimer) {
      self.props.hoverEngagementTimer = setTimeout(function() {
        if (!self.props.isHoverEngaged) {
          handleGaEvent(...track.ENGAGED_WITH_BELOW_THE_LINE_CHART, 'hover');
